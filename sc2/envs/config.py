...
def get_config():
    ...
    parser.add_argument('--map_name', type=str, default='corridor', help="Which smac map to run on")
    ...
    parser.add_argument('--replay_prefix', type=str, default='train')
    parser.add_argument('--replay_save_interval', type=int, default=100)
    return parser
